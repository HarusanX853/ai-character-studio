...
export async function buildCharacterContext(state: EpisodeGraphState): Promise<Partial<EpisodeGraphState>> {
  ...
  const userPrompt = [
    ...
    "2. 禁止复述案件背景、证据全文或其他角色已经说过的话；引用时只保留支持本轮推理所必需的信息。",
    "3. 不要无意义寒暄。",
    "4. 先明确立场，再展开 3 至 6 个彼此不同的核心论点；每段必须提供新的推理、比较、反驳或证据权重判断。",
    "4.1 speech 应逻辑完整，通常控制在 600 至 1800 个中文字符内；合并重复论点，删除寒暄、动作铺垫和无信息量总结。",
